...
FORM f_export.
  ...
  gv_filename = sy-datum && '_SENIOR_1027.csv'.
  gv_header = 'NUMEMP;TIPCOL;NUMCAD;DATALT;CODCAT'.
  ...
  LOOP AT gt_hist ASSIGNING FIELD-SYMBOL(<fs_hist>).
    ...
    DATA: lv_numemp TYPE string,
          ...
          lv_codcat TYPE string.

    PERFORM f_conv_tipcol IN PROGRAM zhr_export_senior
      USING <fs_hist>-persg
      CHANGING lv_tipcol.

    PERFORM f_map_codcat
    ...
    PERFORM f_fit_field USING lv_codcat 3 CHANGING lv_codcat.
...
FORM f_map_codcat
  ...
  CHANGING pv_codcat TYPE string.

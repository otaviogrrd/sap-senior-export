...
FORM f_export.
  ...
  gv_filename = sy-datum && '_1041.csv'.
  gv_header = 'NUMEMP;CODFIL;CMPPTE;TIPCOL;NUMCAD;SEQPTE;SRVTER;NRORPA;PERGRP;CODRET;DATPAG;RENBRU;OUTDES;BASINS;DEDINS;BASIRF;IRFRET;VALISS;CODCCU;PERISS;VALLIQ'.
